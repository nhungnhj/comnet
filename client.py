...
if __name__ == '__main__':
    ...
    for i in range(1,8):
        ...
        relay = "DL" + " " + relay_server_name + " " + server_name + " " + file_name + " " + key + " " + "PARTIAL" + " " + str(0) + " " + str(9) + "\n"
    ...
    for i in range(1,8):
        ...
        client_socket = socket(AF_INET, SOCK_STREAM)
        client_socket.connect((relay_server_name, only_server_port))
        relay = "DLrelay2" + " " + relay_server_name + " " + best_server_name + " " + file_name + " " + key + " " + "PARTIAL" + " " + str(0) + " " + str(9) + "\n"
    ...
    for i in range(1,8):
        ...
        client_socket = socket(AF_INET, SOCK_STREAM)
        client_socket.connect((relay_server_name, only_server_port))
        relay = "DLrelay3" + " " + relay_server_name + " " + best_server_name + " " + file_name + " " + key + " " + "PARTIAL" + " " + str(0) + " " + str(9) + "\n"
        #DLrelay_中継サーバ名_ファイルサーバ名(中継サーバ)_ファイル名_key_partial_0_9\n
        try:
            client_socket.settimeout(3.0)
            client_socket.send(relay.encode())
    ...
    for i in range(1,8):
        ...
        client_socket = socket(AF_INET, SOCK_STREAM)
        client_socket.connect((relay_server_name, only_server_port))
        relay = "DLrelay4" + " " + relay_server_name + " " + best_server_name + " " + file_name + " " + key + " " + "PARTIAL" + " " + str(0) + " " + str(9) + "\n"
        #DLrelay_中継サーバ名_ファイルサーバ名(中継サーバ)_ファイル名_key_partial_0_9\n
        try:
            client_socket.settimeout(3.0)
            client_socket.send(relay.encode())
    ...
    for i in range(1,8):
        ...
        client_socket = socket(AF_INET, SOCK_STREAM)
        client_socket.connect((relay_server_name, only_server_port))
        relay = "DLrelay5" + " " + relay_server_name + " " + best_server_name + " " + file_name + " " + key + " " + "PARTIAL" + " " + str(0) + " " + str(9) + "\n"
        #DLrelay_中継サーバ名_ファイルサーバ名(中継サーバ)_ファイル名_key_partial_0_9\n
        try:
            client_socket.settimeout(3.0)
            client_socket.send(relay.encode())
    ...
    for i in range(1,8):
        ...
        client_socket = socket(AF_INET, SOCK_STREAM)
        client_socket.connect((relay_server_name, only_server_port))
        relay = "GETrelayX" + " " + "dummy" + " " + "dummy" + " " + file_name + " " + key + " " + "PARTIAL" + " " + str(0) + " " + str(9) + "\n"
